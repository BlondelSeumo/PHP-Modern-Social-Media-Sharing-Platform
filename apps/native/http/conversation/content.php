...
$cl["app_statics"] = array(
	"styles" => array(
		cl_css_template("statics/css/apps/conversation/style.master"),
		cl_css_template("statics/css/apps/conversation/style.mq"),
		cl_css_template("statics/css/apps/conversation/style.custom")
	)
);
